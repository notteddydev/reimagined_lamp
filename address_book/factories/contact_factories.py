...
from address_book.models import Contact, Nation, Profession, Tag
...
class ContactFactory(factory.django.DjangoModelFactory):
    ...
    notes: str = factory.Faker("text", max=1000)
    ...
    def anniversary(self) -> datetime:
        ...
        random_days: int = factory.Faker("random_int", min=0, max=delta_days).generate()
