# Generated by Django 5.0.6 on 2024-08-26 23:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nationalities', models.ManyToManyField(blank=True, to='address_book.nation')),
                ('profession', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='address_book.profession')),
            ],
            options={
                'ordering': ['first_name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='address_book.contact')),
                ('tenancy_types', models.ManyToManyField(to='address_book.addresstype')),
            ],
            options={
                'ordering': ['archived'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='contact',
            name='addresses',
            field=models.ManyToManyField(blank=True, through='address_book.Tenancy', to='address_book.address'),
        ),
        migrations.CreateModel(
            name='WalletAddress',
            fields=[
